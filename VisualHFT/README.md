> **Fork notice — VisualHFT-Kalshi**
>
> This is a fork of [silahian/VisualHFT](https://github.com/silahian/VisualHFT)
> (Apache 2.0) with added support for [Kalshi](https://kalshi.com/) prediction
> markets. The fork adds Kalshi-aware Helpers (`Helpers/KalshiCredentials.cs`,
> `KalshiBrowserPoller`, `KalshiEventCatalog`, `KalshiTradeHelper`), an Events
> Browser, a Watch List, a Strike Ladder, and a demo-only order panel.
>
> The Kalshi data plugin source lives in the sibling `visualhft-kalshi/`
> folder of this combined `VisualHFT-Kalshi` repo. See the top-level
...
Learn more about **VisualHFT**'s architecture in [`docs/system-architecture.md`](docs/system-architecture.md) (or the upstream interactive version [here](https://visualhft.github.io/VisualHFT/system-architecture.html)).
